            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/1519905822352-removebg-preview.png') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    ...
                    <li class="nav-item">
                          <a class="nav-link text-white">
                            <h3 class="my-0 text-center"><?= date('l, d / m / Y');?></h3>
                        </a>
                        <a class="nav-link text-white">
                            ...
                            <a class="nav-link" href="<?= base_url('absensi/check_absen') ?>">
                                ...
                                <p class="d-inline">
                                    ...
                                    <?php if($this->session->absen_warning == 'true'): ?>
                                        <span class="float-right notification p-0 badge badgedge-danger"><i class="fa fa-info-circle"></i></span>
                                    <?php endif; ?>
                                </p>
                            </a>
                        </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('dashboard/logout') ?>">
                            <span>Keluar <i class="nc-icon nc-button-power"></i></span>
                        </a>
                    </li>
                </ul>
            </div>
