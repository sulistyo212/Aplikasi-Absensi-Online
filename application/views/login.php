...
<head>
    ...
    <title>Absen KB Insurance | Login</title>
            ...
            <div class="row">
                <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto mt-5">
                    <section id="login-body" class="pt-3" >
                        <div class="card border-0 shadow pt-3" style="background-color: gray">
                            <div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
                                <img src="<?= base_url('assets/img/1519905822352-removebg-preview.png') ?>"class="img-fluid mx-auto d-block">
                                <div class="mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('auth/login') ?>" method="post">
                                    ...
                                    <div class="form-group mt-4">
                                        <button type="submit" class="btn-block" style="background-color: orange">Login</button>
                                    </div>
                                </form>
                            </div>
                        </div>
